...
set(MSG_I_FLAGS "-Iqq_msgs:/home/a/my_ros/src/qq_msgs/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/a/my_ros/src/qq_msgs/msg/Carry.msg" NAME_WE)
add_custom_target(_qq_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "qq_msgs" "/home/a/my_ros/src/qq_msgs/msg/Carry.msg" ""
)
...
_generate_msg_cpp(qq_msgs
  "/home/a/my_ros/src/qq_msgs/msg/Carry.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/qq_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/qq_msgs\")")
  # install generated code
  install(
