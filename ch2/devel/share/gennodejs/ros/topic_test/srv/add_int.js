...
class add_intRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type add_intRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type add_intRequest
    let len;
    let data = new add_intRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new add_intRequest(null);
...
class add_intResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type add_intResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type add_intResponse
    let len;
    let data = new add_intResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new add_intResponse(null);
...
module.exports = {
  Request: add_intRequest,
  Response: add_intResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'topic_test/add_int'; }
};
