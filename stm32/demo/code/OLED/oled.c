...
void oled_entry(void *parameter)
{
    while(1)
    {
        Voltage_Show=ADC_Value*100;

        OLED_ShowString(0,10,"A");
        if(Motor_A.Speed<0)   OLED_ShowString(15,10,"-"),OLED_ShowNumber(20,10,-Motor_A.Speed*1000,5,12);
        else                    OLED_ShowString(15,10,"+"),OLED_ShowNumber(20,10,  Motor_A.Speed*1000,5,12);

        OLED_ShowString(0,20,"B");
        if(Motor_B.Speed<0)   OLED_ShowString(15,20,"-"),OLED_ShowNumber(20,20,-Motor_B.Speed*1000,5,12);
        else                    OLED_ShowString(15,20,"+"),OLED_ShowNumber(20,20,  Motor_B.Speed*1000,5,12);

        OLED_ShowString(0,30,"C");
        if(Motor_C.Speed<0)   OLED_ShowString(15,30,"-"),OLED_ShowNumber(20,30,-Motor_C.Speed*1000,5,12);
        else                    OLED_ShowString(15,30,"+"),OLED_ShowNumber(20,30,  Motor_C.Speed*1000,5,12);

        OLED_ShowString(0,40,"D");
        if(Motor_D.Speed<0)   OLED_ShowString(15,40,"-"),OLED_ShowNumber(20,40,-Motor_D.Speed*1000,5,12);
        else                    OLED_ShowString(15,40,"+"),OLED_ShowNumber(20,40,  Motor_D.Speed*1000,5,12);
...
void OLED_Thread_Init(void)
{
    ...
    oled_th = rt_thread_create("oled_th", oled_entry, RT_NULL, 512, 31, 10);
    rt_thread_startup(oled_th);
